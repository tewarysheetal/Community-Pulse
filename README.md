...
A data pipeline for US Census ACS and PUMS data focused on Champaign, Illinois. Loads multi-year demographic and housing microdata into PostgreSQL for community-level analysis, including ALICE (Asset Limited, Income Constrained, Employed) household profiling and Tableau-ready statistical exports.
