DROP TABLE IF EXISTS alice_household_profile_2022;

CREATE TABLE alice_household_profile_2022 AS
SELECT
    hb.serialno,
    hb.state,
    hb.puma,
...
FROM alice_household_base_2022 hb
LEFT JOIN alice_household_student_agg_2022 hsa
