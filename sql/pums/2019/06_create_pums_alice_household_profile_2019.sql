DROP TABLE IF EXISTS alice_household_profile_2019;

CREATE TABLE alice_household_profile_2019 AS
SELECT
    hb.serialno,
    hb.state,
    hb.puma,
...
FROM alice_household_base_2019 hb
LEFT JOIN alice_household_student_agg_2019 hsa
