drop table if exists alice_nonstudent_stat_profile_2019;

        create table alice_nonstudent_stat_profile_2019 as
        with base as (
            select *
        ...
        select
            ...
            'nonstudent_below_alice'::text as population_type,
