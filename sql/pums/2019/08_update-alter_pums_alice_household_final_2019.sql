alter table alice_household_final_2019 add column if not exists hincp_adj_real numeric;
update alice_household_final_2019
set hincp_adj_real = (hincp::numeric * adjinc::numeric) / 1000000.0;

alter table alice_household_final_2019 add column if not exists student_heavy_flag integer;
update alice_household_final_2019
