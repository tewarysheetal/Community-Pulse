DROP TABLE IF EXISTS alice_household_profile_2023;

CREATE TABLE alice_household_profile_2023 AS
SELECT
    hb.serialno,
    hb.state,
    hb.puma,
...
FROM alice_household_base_2023 hb
LEFT JOIN alice_household_student_agg_2023 hsa
