drop table if exists alice_household_profile_2023_adj;

create table alice_household_profile_2023_adj as
select
    a.*,
    case
...
from alice_household_profile_2023 a
cross join (
    select alpha
    from alice_puma1902_alpha
    where alloc_year = 2023
) p
