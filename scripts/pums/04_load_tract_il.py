...
data_dir = Path(r"D:\Projects\Community-Pulse\data\metadata")
file_path= data_dir / "Tract_Illinois.csv"
...
df.to_sql("alice_tract_illinois_raw", engine, if_exists="replace", index=False)

print(f"Done: alice_tract_illinois_raw ({len(df)} rows)")
